...
passport.use(new LocalStrategy({
        usernameField: 'email',
        passReqToCallback : true  //to unable flash in if there a invalid password etc in sign in 
    },
    function(req,email, password, done){
        ...
        User.findOne({email: email}, function(err, user)  {
            ...
            if (!user || user.password != password){
                //console.log('Invalid Username/Password'); jb flash nhi tha tb ye use kra tha
